...
sudo apt -y install wget && cd /home/$USER && wget https://raw.githubusercontent.com/sneepzity/beezity-scripts/refs/heads/main/ubuntu-helper.sh && chmod +x ubuntu-helper.sh && mkdir -p /home/$USER/beezity-scripts && cp /home/$USER/ubuntu-helper.sh /home/$USER/beezity-scripts && rm -rf /home/$USER/ubuntu-helper.sh && cd beezity-scripts && ./ubuntu-helper.sh 
