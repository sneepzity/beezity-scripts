...
yay -S -y refind gnu-unifont noto-fonts noto-fonts-cjk noto-fonts-extra noto-fonts-emoji arch-gaming-meta dxvk-gplasync-bin-git ttf-ms-win11-auto linux-cachyos linux-cachyos-headers proton-cachyos proton-ge-custom-bin wine-cachyos cachyos-ananicy-rules wine-tkg-staging-bin wike-tkg-statging-wow64-bin
refind-install
